    ...
    public class Products
    {
        ...
        private static Position[] GetPosition()
        {
            return [
                ...
                new Position() { Date = new DateTime(2022, 03, 24), ProductKey = "E", Amount = 80 }];
        }

        private static decimal CalMarketValue(decimal price, decimal amount)
        {
            return price * amount;
        }
    }
